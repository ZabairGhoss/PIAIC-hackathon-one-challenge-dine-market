    ...
    <footer>
        ...
        <div className="flex flex-col col-span-2 justify-between w-[80%] gap-10">
          ...
          <div className="flex gap-[1rem]">
            <div className="px-[12px] py-[10px] bg-[#f1f1f1] rounded-[10px] cursor-pointer">
              <Link href={'https://twitter.com/czubair307'} target="_blank">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
            ...
            <div className="px-[12px] py-[10px] bg-[#f1f1f1] rounded-[10px] cursor-pointer">
            <Link href={'https://www.facebook.com/chzubair.ghous/'} target="_blank">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
            ...
            <div className="px-[12px] py-[10px] bg-[#f1f1f1] rounded-[10px] cursor-pointer">
            <Link href={'https://www.linkedin.com/in/zabair-ghoss1/'} target="_blank">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
      ...
      <div className="mt-[6rem] border-t-2 border-solid border-[#666] grid grid-cols-3">
        ...
        <p className="mx-auto my-[1.5rem] font-normal text-[1rem] leading-[22px] text-[#666]">
          Code by.{" "}
          <span className="font-bold text-[1rem] leading-[15px] text-[#212121]">
            <Link className="mr-[2px]" href={'https://github.com/ZabairGhoss'}>
              ZabairGhoss 
            </Link>
            on github
          </span>
